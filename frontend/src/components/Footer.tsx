      ...
      <div className="container py-3">
        <div className="container py-3">
          <div className="row pt-5">
            <div className={`${styles.navCol} col-10  col-sm-10 col-md-10 col-lg-4`}>
              <Image
                src={logo}
                className=" rounded"
                alt=""
            ...
            <div className={`${styles.navCol} col-10 mt-5 col-sm-10 mt-sm-5 col-md-11 mt-md-5 col-lg-4 mt-lg-0`}>
              <h5 className="h5">Contacts</h5>
              <span className={` ${styles.para} h6 pt-2 `}>Basundhara, Kathmandu, Nepal</span>
              <span className={` ${styles.para} h6 pt-2 `}>ancienthimalayantreks@gmail.com</span>
              <span className={` ${styles.para} h6 pt-2 `}>+977 9851337204</span>
            </div>
            ...
            <div className="col-10 mt-5 col-md-10 col-sm-10 mt-sm-5 mt-md-5 col-lg-4 mt-lg-0 ">
              <div className="row ">
                ...
                <p className={` ${styles.para} h6 pt-4 lh-lg `}>Subscribe to our newsletter of follow us on the social channels to stay tuned.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container">
        <div className="row container ">
          <p className="col col-12 lh-base m col-xl-8 col-lg-8 col-md-12 col-sm-12">
            ...
            <a
              className="link"
              href={"https://falcontechnepal.com/"}>
              falcontech.com
            </a>
          </p>
          <p className="col ">
