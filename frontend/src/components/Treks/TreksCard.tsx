...
import TreksCategoryNavbar from "./TreksCategoryNavbar";

const TreksCard = () => {
  return (
    <div className="pb-5" style={{ backgroundColor: "#EFF3F6" }}>
      <div className="container ">
        <div className="container m-5 mt-0">
          <TreksCategoryNavbar />
          <div className="card-group py-5 mx-5  gap-3">
            {/* Card */}
            <motion.div
              whileHover={{ y: 30 }}
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              className="card-4  mb-4 border-0  shadow rounded"
              style={{ width: "22rem" }}
            >
              ...
              <div className="card-body p-3">
                ...
                <p className="mainColor pt-3 lh-lg  card-text">
                  ...
                  village This is a wider card with supporting text below as a
                  card with supporting text below.
                </p>
                <div className="col">
