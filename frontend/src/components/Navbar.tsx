                  ...
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0 gap-3">
                    ...
                    {/* <li className="nav-item dropdown  fw-bold">
                      ...
                      <ul className="dropdown-menu">
                        <Link href="/team">
                          <li className="pageLi">
                            <a className="navLi dropdown-item  fw-bold ">TEAM</a>
                          </li>
                        </Link>

                        <Link href="/shelter">
                          <li className="pageLi">
                            <a className="dropdown-item fw-bold navLi">SHELTERS</a>
                          </li>
                        </Link>

                        <Link href="/history">
                          <li className="pageLi">
                            <a className="dropdown-item fw-bold navLi">HISTORY</a>
                          </li>
                        </Link>

                        <Link href="/price">
                          <li className="pageLi">
                            <a className="dropdown-item fw-bold navLi">PRICES</a>
                          </li>
                        </Link>

                        <Link href="/events">
                          <li className="pageLi">
                            <a className="dropdown-item fw-bold navLi">EVENTS</a>
                          </li>
                        </Link>
